...
class ChaseMultiDiscrete(gym.Env):
    def __init__(self, grid_size=10):
        super(ChaseMultiDiscrete, self).__init__()
        ...
        self.observation_space = gym.spaces.Dict(
            {
                ...
                "random": gym.spaces.MultiDiscrete([5, 5, 5]),
            }
        )
